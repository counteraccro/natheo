...
export default {
  ...
  methods: {
    ...
    loadTranslateListeFile() {
      this.files = [];
      this.loading = true;
      axios.get(this.url_translates_files + '/' + this.currentLanguage, {}).then((response) => {
    ...
    <div v-if="this.file.length !== 0">
      <div class="card mt-3 border border-secondary">
        ...
        <div class="card-header text-bg-secondary">
          ...
          <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle btn-sm float-end" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="bi bi-list"></i>
            </button>
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item no-control" href="#" @click="this.saveTranslate"><i class="bi bi-save-fill"></i> {{ this.trans.translate_btn_save }}</a>
              </li>
              <li><a class="dropdown-item no control" href="#" @click="this.reloadCache(true)">
                <i class="bi bi-repeat"></i> {{ this.trans.translate_btn_cache }}</a></li>
            </ul>
          </div>
          <div class="mt-1">
