    ...
    <div class="card-body" v-else>
      ...
      <ul class="list-group mb-2">
        <li class="list-group-item list-group-item-warning">
          <i class="bi bi-exclamation-circle"></i> {{ this.translate.option_1 }}
        </li>
        <li class="list-group-item list-group-item-warning">
          <i class="bi bi-exclamation-circle"></i> {{ this.translate.option_2 }}
        </li>
        <li class="list-group-item list-group-item-warning">
          <i class="bi bi-exclamation-circle"></i> {{ this.translate.option_3 }}
        </li>
        <li class="list-group-item list-group-item-success"><i class="bi bi-check-circle"></i> aaaa</li>
      </ul>
