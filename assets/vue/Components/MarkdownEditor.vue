...
<template>
    ...
    <div class="editor">
        ...
        <textarea :id="'editor-'+ this.id" class="form-control no-control" :class="this.isValide" :value="this.value" @input="update" :rows="this.meRows" @change="this.isValideInput"></textarea>
