...
<template>
    ...
    <div class="flex flex-wrap justify-between gap-10">
      <div class="max-w-md">
        ...
        <div v-if="this.data.type === this.menuType.colonne" v-for="element in this.data.elements" class="max-lg:min-w-[140px]">
          <h4 class="text-slate-900 font-semibold text-sm relative max-sm:cursor-pointer">{{element.label}}</h4>
