...
<template>
  <div class="flex flex-wrap gap-10" :class="this.css[this.data.type].flexDirection">
    <div :class="this.css[this.data.type].w">
      <a
        :href="this.optionsSystem.OS_ADRESSE_SITE"
    ...
    <div
      v-if="this.data.type === this.menuType.colonne"
    ...
    <div
      v-if="this.data.type === this.menuType.left"
      v-for="element in this.data.elements"
      class="max-lg:min-w-[140px]"
    >
      <a
    ...
    <div
      v-if="this.data.type === this.menuType.center"
      v-for="element in this.data.elements"
      class="max-lg:min-w-[140px]"
    >
      <a
  ...
  <div>
    <ul class="md:flex md:space-x-6 max-md:space-y-2 mt-3">
      <li>
        <a
          :href="this.urls.indexFr"
          class="text-slate-600 font-normal hover:bg-theme-4-750 hover:!text-theme-1-100 rounded-md hover:dark:bg-gray-600 p-1.5"
          >{{ this.translate.frLink }}</a
        >
      </li>
      <li>
        <a
          :href="this.urls.indexEn"
          class="text-slate-600 font-normal hover:bg-theme-4-750 hover:!text-theme-1-100 rounded-md hover:dark:bg-gray-600 p-1.5"
          >{{ this.translate.enLink }}</a
        >
      </li>
      <li>
        <a
          :href="this.urls.indexEs"
          class="text-slate-600 font-normal hover:bg-theme-4-750 hover:!text-theme-1-100 rounded-md hover:dark:bg-gray-600 p-1.5"
          >{{ this.translate.esLink }}</a
        >
      </li>
    </ul>
  </div>
  ...
  <div class="flex flex-wrap max-md:flex-col gap-4">
    <ul class="md:flex md:space-x-6 max-md:space-y-2">
      <li>
        <a
          href="https://github.com/counteraccro/natheo"
          class="text-slate-600 font-normal hover:bg-theme-4-750 hover:!text-theme-1-100 rounded-md hover:dark:bg-gray-600 p-1.5"
          >{{ this.translate.githubLink }}</a
        >
      </li>
      <li>
        <a
          ...
          class="text-slate-600 font-normal hover:bg-theme-4-750 hover:!text-theme-1-100 rounded-md hover:dark:bg-gray-600 p-1.5"
          >{{ this.translate.adminLink }}</a
        >
      </li>
      <li>
        <a
          :href="this.urls.sitemap"
          class="text-slate-600 font-normal hover:bg-theme-4-750 hover:!text-theme-1-100 rounded-md hover:dark:bg-gray-600 p-1.5"
          >{{ this.translate.sitemapLink }}</a
        >
      </li>
      <li>
        <a
