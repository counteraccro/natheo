  ...
  <ul :class="this.deep > 0 ? 'px-' + (this.deep+2):''">
    <li v-for="element in this.data">
      <a
          ...
          class="!text-gray-500 hover:bg-theme-4-750 hover:!text-theme-1-100 px-2 py-1 rounded-md text-sm font-medium hover:dark:bg-gray-600"
