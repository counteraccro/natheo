...
<template>
  <nav class="navbar navbar-expand-lg bg-body-tertiary" id="navbar-header-demo">
    <div class="container-fluid">
      <a class="navbar-brand" :href="this.data.url_site"
        ><i class="bi" :class="this.data.logo"></i> {{ this.data.name }}</a
      >
      <button
        ...
        <ul class="navbar-nav" v-if="this.type === 2">
          ...
          >
            ...
            <ul
              ...
              class="dropdown-menu"
              v-html="this.renderDeepDropDown(element, '')"
            ></ul>
          </li>
        </ul>
        ...
        <ul class="navbar-nav" v-if="this.type > 2">
          ...
          >
            ...
            <div v-if="this.isHaveChildren(element)" class="dropdown-menu megamenu" role="menu">
              <div class="row" v-html="this.renderBigMenu(element, '')"></div>
            </div>
          </li>
        </ul>
      </div>
