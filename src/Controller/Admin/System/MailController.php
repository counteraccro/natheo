...
class MailController extends AppAdminController
{
    ...
    ): JsonResponse
    {
        ...
        $tabKeyWord = match ($mail->getKey()) {
            ...
            $keyWord->getMailChangePassword($user, $this->generateUrl('front_index'), $optionSystemService),
            ...
            $keyWord->getTabMailCreateAccountAdm($user, $user, $this->generateUrl('front_index'), $optionSystemService),
            ...
            $keyWord->getTabMailResetPassword($user, $user, $this->generateUrl('front_index'), $optionSystemService),
            default => [
                KeyWord::KEY_SEARCH => [],
                KeyWord::KEY_REPLACE => []
            ],
