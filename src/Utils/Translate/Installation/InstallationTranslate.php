...
class InstallationTranslate extends AppTranslate
{
    ...
    public function getTranslateStepTwo(): array
    {
        return [
            ...
            'finish_installation_title' => $this->translator->trans('installation.step.2.finish.titre', domain: 'installation'),
            'finish_installation_text_1' => $this->translator->trans('installation.step.2.finish.texte.1', domain: 'installation'),
            'finish_installation_text_2' => $this->translator->trans('installation.step.2.finish.texte.2', domain: 'installation'),
            'finish_installation_btn' => $this->translator->trans('installation.step.2.finish.btn', domain: 'installation'),
            'finish_installation_loading_msg_success' => $this->translator->trans('installation.step.2.finish.loading.msg.success', domain: 'installation'),
            'finish_installation_loading_msg_config' => $this->translator->trans('installation.step.2.finish.loading.msg.config', domain: 'installation'),
            'finish_installation_loading_msg_config_success' => $this->translator->trans('installation.step.2.finish.loading.msg.config.success', domain: 'installation'),
            'finish_installation_loading_msg_config_ko' => $this->translator->trans('installation.step.2.finish.loading.msg.config.ko', domain: 'installation'),
            'finish_installation_loading_msg_installation_data' => $this->translator->trans('installation.step.2.finish.loading.msg.installation.data', domain: 'installation'),
            'finish_installation_loading_msg_installation_data_success' => $this->translator->trans('installation.step.2.finish.loading.msg.installation.data.success', domain: 'installation'),
            'finish_installation_loading_msg_installation_data_ko' => $this->translator->trans('installation.step.2.finish.loading.msg.installation.data.ko', domain: 'installation'),
            'finish_installation_loading_msg_cache' => $this->translator->trans('installation.step.2.finish.loading.msg.cache', domain: 'installation'),
            'finish_installation_loading_msg_cache_success' => $this->translator->trans('installation.step.2.finish.loading.msg.cache.success', domain: 'installation'),
            'finish_installation_loading_msg_cache_ko' => $this->translator->trans('installation.step.2.finish.loading.msg.cache.ko', domain: 'installation'),
        ];
    }
}
