...
class ApiTokenTranslate extends AppTranslate
{
    ...
    public function getTranslate(): array
    {
        return [
            ...
            'comment_placeholder' => $this->translator->trans('api_token.card.comment.placeholder', domain: 'api_token'),
            ...
            "modale_title_confirm_btn_ko" => $this->translator->trans('api_token.modale.confirm.edit.btn_ko', domain: 'api_token'),
        ];
    }
}
