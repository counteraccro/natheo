...
namespace App\Entity\Admin\Content\Comment;
...
class Comment
{
    ...
    #[ORM\ManyToOne]
    private ?User $userModeration = null;
    ...
    public function getUserModeration(): ?User
    {
        return $this->userModeration;
    }

    public function setUserModeration(?User $userModeration): static
    {
