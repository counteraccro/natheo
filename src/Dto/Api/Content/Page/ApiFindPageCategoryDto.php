 ...
 * @version 1.0
 * Object de Transfère de Données pour la récupération d'une liste de page par catégorie
 */
...
class ApiFindPageCategoryDto extends AppApiDto
{
    public function __construct(
         ...
         * @var string
         */
        #[Assert\Type(type: 'string', message: 'The category parameter must be a string')] #[
            Assert\NotBlank,
        ]
